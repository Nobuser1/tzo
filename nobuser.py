...
\033[1;92m******************************************\033[0m
[👉] \033[1;93mGithub\033[0m   : \033[1;93mNobuser1\033[0m
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/Nobuser1/tzo/blob/main/Approval.txt').text
...
[👉] \033[1;92mVersion\033[0m  : \033[1;92m1.1\033[0m
\033[1;92m******************************************\033[0m""")
  print(f" \033[1;33m  THIS TOOLS IS FREE BUT YOU NEED GET APPROVED FIRST\033[1;37m\n")
  print(f"")
  ...
  print(f"")
  try:
    httpCaht = requests.get("https://github.com/Nobuser1/tzo/blob/main/Approval.txt").text
    if id in httpCaht:
      ...
      print(f"    Send Real Smile Emoji or Fake Smile  Emoji to Admin and get aproval"); time.sleep(2)
