...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/NaungTa1/Approval/main/Paid.txt ').text
...
\033[1;92m******************************************\033[0m""")
  ...
  print(f"")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/NaungTa1/Approval/main/Paid.txt").text
    if id in httpCaht:
